...
--掩码定义
cmd.BET_ITEM_TYPE_MASK          =0xff                               --动物类型 - 颜色
...
--
cmd.DRAW_ZHUANG                 =0x00010000                         --开庄 
cmd.DRAW_HE                     =0x00020000                         --开和
cmd.DRAW_XIAN                   =0x00040000                         --开闲
...
----]]
--[[
cmd.Camera_Normal_Vec3 = cc.vec3(0, 90, -90)
cmd.Camera_Rotate_Vec3 = cc.vec3(0, 90, -90)
cmd.Camera_Win_Vec3 = cc.vec3(0, 100, -90)
--]]
...
cmd.CMD_S_Status_Base=
{
    ...
    {k="cbEnjoyIndexList",t="byte",l={3}} -- 庄闲和倍率

};

--命令定义
--[[
cmd.SUB_S_START_FREE            =99                                  --空闲时间
cmd.SUB_S_START_BET             =1                                  --开始下注
cmd.SUB_S_START_DRAW            =100                                  --开始开奖
cmd.SUB_S_DRAW_RESULT			=102                                  --派彩时间
cmd.SUB_S_BETCOUNT_CHANGE       =105                                  --下注额改变
...
cmd.CMD_S_Start_Draw=
{
	--时间变量
	{k="cbDrawTimeCount",t="byte"},--开奖时间
	{k="cbPointerColor",t="byte"},--指针颜色	0 是红色 1 是绿色 2 是黄色
...
cmd.CMD_S_Draw_Result=
{
    ...
    {k="iAniBei",t="int"},-- 动物的倍率
    {k="iEnjoyBei",t="int"}-- 庄闲和的倍率
